...
function inicializarTablaHistorico(datosDB, container) {
    ...
    const colHeadersHistorico = [
        ...
        'OBSERVACIÓN ASIGNACIÓN ÚLTIMA', 'GESTIÓN ASIGNACIÓN ÚLTIMA', 'TIPO TRABAJO ASIGNACIÓN ÚLTIMA','MOTIVO PQR',
    ...
    const tableDataHistorico = datosDB.map(row => [
        ...
        row.OBSERVACIÓN_ASIGNACIÓN_ULTIMA, row.GESTIÓN_ASIGNACIÓN_ULTIMA, row.TIPO_TRABAJO_ASIGNACIÓN_ULTIMA,row.MOTIVO_DE_PQR,
