...
Route::middleware('web')->group(function () {
    ...
    Route::middleware('auth')->group(function () {
        ...
        Route::post('pqrs/coordinacion/update-asignado', [CoordinacionPQRS::class, 'updateAsignado'])->name('pqrs.coordinacion.updateAsignado')->middleware(CheckPermission::class . ':coordinacion_pqrs');
        Route::get('pqrs/coordinacion/historico', [CoordinacionPQRS::class, 'getHistorico'])->name('pqrs.coordinacion.historico')->middleware(CheckPermission::class . ':coordinacion_pqrs');
        ...
        Route::get('/pqrs/coordinacion/datos-actualizados', [App\Http\Controllers\PQRS\CoordinacionPQRS::class, 'getDatosActualizados'])->name('pqrs.coordinacion.datosActualizados')->middleware(CheckPermission::class . ':coordinacion_pqrs');
