 ...
 *
 * Laravel sólo trae los de inglés, y los formularios mostraban «The email
 * field is required.» aunque la aplicación entera esté en español.
 *
 * Van en `resources/lang` y no en `lang/`, que es donde los pondría hoy un
 * proyecto nuevo: Laravel lee `resources/lang` si esa carpeta existe, y existe
 * porque guarda restos de AdminLTE. Puestos en `lang/es` no se cargaban. Las claves son las mismas que las del archivo del
 * framework (`vendor/laravel/framework/src/Illuminate/Translation/lang/en`),
 * con los mismos marcadores; si una versión nueva de Laravel añade reglas,
 * hasta traducirlas saldrán en inglés por el idioma de reserva.
 */
...
return [
    ...
    /*
     * Cómo se nombra cada campo dentro del mensaje. Sin esto el mensaje usa el
     * nombre del input tal cual: «El campo type id es obligatorio».
     */
    'attributes' => [
        'name' => 'nombre',
