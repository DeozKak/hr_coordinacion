...
@section( 'content')
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-12">
                <div class="col-md-12 table-responsive" style="padding: 15px;">
                    <div class="card">
                        <div class="card-body">
                            <a href="{{ route('programacion.create') }}" class="btn btn-success btn-sm"
                               title="Add New Programacion">
                                <i class="fa fa-plus" aria-hidden="true"></i> Generar nueva Tabla
                            </a>
                            @haspermission('ver_programacion')

                            <button id="openModalBtn" class="btn btn-primary btn-sm" title="Añadir a Base"> Añadir a
                                Base
                            </button>
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control" id="buscadorContrato"
        ...
        <!-- Modal base -->
        <div class="modal fade" id="addProgramacionModal" tabindex="-1" aria-labelledby="addProgramacionModalLabel"
             aria-hidden="true">
        ...
        <div class="modal fade" id="addMasivoModal" tabindex="-1" aria-labelledby="addMasivoModalLabel"
             aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
    ...
    <!-- Call center GDO -->
    <div class="modal fade" id="callcenterGDO" tabindex="-1" aria-labelledby="callcenterGDOLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="callcenterGDOLabel">Programadas GDO</h5>
                    <button type="button" class="callcenterGDO" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form action="#" id="callcenterGDOForm" method="POST" enctype="multipart/form-data">
                        ...
                        <button id="submit-callcenterGDO" class="btn btn-primary" type="submit">Cargar</button>
                    </form>
                </div>
            </div>
        </div>
    ...
    @section('js')
        <script src="{{ asset('js/programacion/indexProgramacionV3-7.js') }}" type="text/javascript"></script>
