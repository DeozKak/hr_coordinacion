    ...
    <tr>
        <td align="center">
            <table class="card" width="600" cellpadding="0" cellspacing="0" border="0"
                   style="background-color: #ffffff; border-radius: 10px; box-shadow: 0 5px 15px rgba(0,0,0,0.1);
                              margin: 40px auto; padding: 20px; border: 1px solid #e1e1e1;">

                <!-- Logo -->
                <tr>
                    <td align="center" style="padding-bottom: 20px;">
                        <img src="<?php echo(asset('vendor/adminlte/dist/img/logo_EYC_2.png'))?>"
                             alt="Logo Empresa" width="250"
                             style="display: block; border-bottom: 2px solid #007bff; padding-bottom: 10px;">
                    </td>
                </tr>
                ...
                <tr>
                    <td class="card-body"
                        style="padding: 25px; text-align: left; color: #333; font-size: 16px; line-height: 1.6;">
                        <p style="margin-bottom: 15px;">
                            Se agregó el contrato <strong><?php echo($contrato) ?></strong> a producción el día <strong><?php echo($fecha) ?></strong>.
                        </p>

                        <p style="margin-bottom: 15px;">
                            El inspector asignado es: <strong><?php echo($inspector->apellidos." ". $inspector->nombres) ?></strong>.
                        </p>

                        <p style="text-align: left; margin: 25px 0;">
                            <a href="<?php echo (route('produccion.detalles')) ?>"
                               class="button"
                ...
                <tr>
                    <td class="footer"
                        style="background-color: #f8f9fa; padding: 15px; font-size: 13px;
                                   color: #666; text-align: center; border-radius: 0 0 8px 8px;">
