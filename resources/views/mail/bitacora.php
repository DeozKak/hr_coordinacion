...
<head>
    <meta charset="UTF-8">
    <title>Bitácora <?php echo($user) ?> | Generada</title>
</head>
                ...
                <tr>
                    <td style="padding: 25px; text-align: left; color: #333; font-size: 16px; line-height: 1.6;">
                        ...
                        <p style="text-align: left; margin: 25px 0;">
                            <a href="<?php echo (route('bitacoras.ver_reporte', ['id_bitacora' => $bitacora])) ?>" style="display: inline-block; background-color: #007bff; color: white; padding: 13px 23px; text-decoration: none; border-radius: 6px; font-weight: bold; font-size: 16px;">
                                Ver Reporte
                            </a>
                        </p>
